...
<td style="height: 10%;">
	<form action="" method="post">
		<span><button>Claudia Portocarrero</button></span>
		<span><button>Eveling Rojas</button></span>
		<span><button>Norma Garcia</button></span>
		<span><button>Elena Sobalbarro</button></span>
		<span><button>Silvia Garcia</button></span>
		<span><button>Eyguer Moreno</button></span>
	</form>
</td>
</table>
