...
function getDatesFromSuperv($idSupervisor, $rangoFecha) {
    ...
    $sql = "SELECT date_format(FechaRegistro, '%Y-%m-%d') AS date_formatted FROM usuario_asistencia WHERE idUsuario = '$idSupervisor' AND FechaRegistro BETWEEN '$rangoFecha[0]' AND '$rangoFecha[1]'  GROUP BY date_formatted ORDER BY date_formatted DESC ";
                        ...
                        <div class="box box-solid box-danger">
                            <div class="box-header with-border">  
                                ...
                                <div class="col-sm-6 col-md-8">
                                    <form method="post" action="asistencia-detalles.php">
                                        <!-- Date and time range -->
                                        <div class="form-group">                                            
                                            <div id="rangofecha" class="input-group">
                                                ...
                                                <!--                                                <button type="button" class="btn btn-default" id="daterange-btn">
                                                                                                    <span name="rangoFechas"><i class="fa fa-calendar"></i> Seleccione rango de fecha</span>
                                        ...
                                        <input type="submit" class="btn-info" name="btnConsultar" value="Consultar">
                                    </form>
                                </div>
                            </div>
                                                            ...
                                                            if ($row_cnt > 0) {
                                                                ...
                                                                while ($rf = mysqli_fetch_array($resFoto)) {
                                                                    ...
                                                                    echo "<div  style='width: 300px; display: inline-block; margin: 1px;'>
                                                                                            ...
                                                                                            <button id='chkAgregPPtX' name='" . $rf['Foto_URL'] . "' onclick='AgregaraPowerPoint(this);' class='ion-ios-plus-empty right-icon'></button>
...
<!--        <script src="<?php echo $Servidor; ?>plugins/PptxGenJS/libs/jszip.min.js" type="text/javascript"></script>
        ...
        <script>
                            ...
                            function AgregaraPowerPoint(elemento) {
                                if (!FnContieneArray(ElementosPresentacionPPTX, elemento.name)) {
