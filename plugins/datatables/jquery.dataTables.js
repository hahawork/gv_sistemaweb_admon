...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Mostando 1 to 10 of 57 entries") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Mostando _START_ a _END_ de _TOTAL_ elementos
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Mostando page _PAGE_ of _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *  @type string
			 *  @default Mostando 0 to 0 of 0 entries
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Mostando 0 a 0 de 0 elementos",
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Mostando x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
