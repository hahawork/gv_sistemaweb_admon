...
<html >
    ...
    <body class="hold-transition layout-boxed skin-blue login-page" style="background:-webkit-gradient(linear, 100% 30%, 100% 100%, from(#00000F), to(#0046FF))">
        <div class="login-box">
...
<!--        para el efecto de copos de nieve callendo-->
